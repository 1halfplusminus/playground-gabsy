        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    allMarkdown = _b.sent();
                    if (allMarkdown.data) {
                        allMarkdown.data.allMarkdownRemark.edges.forEach(function (edge) {
                            ...
                            createPage({
                                path: slug,
                                component: path_1.resolve(__dirname, "../src/templates/blog-post.tsx"),
                                context: {
                                    slug: slug,
                                },
                            });
